...
import { getMessages, uploadFile, deleteFile, deleteMessage, downloadFile } from "../controllers/MessagesController.js";
...
messagesRoute.post("/download-file/:id", verifyToken, downloadFile);
